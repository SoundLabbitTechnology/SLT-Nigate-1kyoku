...
export const PlayerView: React.FC<PlayerViewProps> = ({
  ...
  // Song Input Form State (for Presenter)
  ...
  const [secretEpisode, setSecretEpisode] = useState<string>('');
      ...
      {phase === 'SONG_INPUT' && isPresenter && (
        <div className="vmc-card p-5 sm:p-6 space-y-5">
          ...
          <div className="bg-[#ECE8DA] border-2 border-[#38312E] rounded-xl p-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              {SONG_PRESETS.map((preset) => (
                ...
                >
                  <div className="font-black text-[#38312E] truncate">
                    {preset.theme}
                  </div>
                  <div className="text-[10px] text-[#38312E]/70 truncate">
                    {preset.description}
                  </div>
                </button>
              ))}
          ...
          <form onSubmit={handleSubmitSongs} className="space-y-4">
            ...
            {/* Secret Confession Episode input */}
